...
pub const REGISTRY: &[CommandSpec] = &[
    ...
    spec!(Studio, "/studio", &[], "/studio", "open the browser studio: real WebRTC video + screen share + face-tracked AR hats + three.js, sharing this room", VideoChat, None, true),
    ...
    spec!(VideoMode, "/vmode", &["/videomode"], "/vmode", "cycle video fidelity: ascii glyphs, half-block (2x res), or true pixels", VideoCamera, None, false),
